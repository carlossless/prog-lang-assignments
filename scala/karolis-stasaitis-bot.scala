// Karolis Stasaitis Bot. Spams Slaves until slave time is 800 or 500 energy, then slaves return to Master
...
object ControlFunction {
  def forMaster(bot: Bot) {
    ...
    val (directionValue, dangerousEnemy) = analyzeView(bot.view, true)
